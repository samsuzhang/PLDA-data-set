...
string illegal_analyse_6(vector<vector<string>>& input1, vector<vector<string>>& input2) {
	...
	for (int i = 0; i < size1; i++) {
		...
		if (!strcmp(implicit_process_by_circulation(implicit_process_by_branch(input1[i][1])).c_str(), "Sam")) {
			result += input1[i][3] + " ";
		}
	}
